...
public class SalaryCalculatorTest {
    ...
    public void salaryMultiplierWhenDaysSkippedIs4() {
        assertThat(calculator.salaryMultiplier(4))
                .isEqualTo(1.0);
    }
    ...
    public void salaryMultiplierWhenDaysSkippedIs5() {
        assertThat(calculator.salaryMultiplier(5))
                .isEqualTo(0.85);
    }
    ...
    public void salaryMultiplierWhenDaysSkippedIs6() {
        assertThat(calculator.salaryMultiplier(6))
                .isEqualTo(0.85);
    }
    ...
    public void bonusMultiplierWhenProductsSoldIs19() {
        assertThat(calculator.bonusMultiplier(19))
                .isEqualTo(10);
    }
    ...
    public void bonusMultiplierWhenProductsSoldIs20() {
        assertThat(calculator.bonusMultiplier(20))
                .isEqualTo(13);
    }
    ...
    public void bonusMultiplierWhenProductsSoldIs21() {
        assertThat(calculator.bonusMultiplier(21))
                .isEqualTo(13);
    }
    ...
    public void bonusForProductsSoldWhenProductsSoldIs5() {
        assertThat(calculator.bonusForProductsSold(5))
                .isEqualTo(50);
    }
    ...
    public void regularSalary() {
        assertThat(calculator.finalSalary(0, 0))
                .isEqualTo(1000.0);
    }
    ...
    public void skippedAboveThreshold() {
        assertThat(calculator.finalSalary(7, 0))
                .isEqualTo(850.0);
    }
    ...
    public void skippedBelowThresholdAndSoldBelowThreshold() {
        assertThat(calculator.finalSalary(2, 5))
                .isEqualTo(1050.0);
    }
    ...
    public void salaryRespectMaximum() {
        assertThat(calculator.finalSalary(0, 77))
                .isEqualTo(2000.0);
    }
